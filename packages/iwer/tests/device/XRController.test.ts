...
import {
  XRController,
  XRControllerConfig,
} from '../../src/device/XRController.js';
...
describe('XRController', () => {
  ...
  beforeEach(() => {
    ...
    (XRTrackedInput as any).mockImplementation(function (
      this: any,
      inputSource: any,
    ) {
  ...
  describe('constructor', () => {
    ...
    it('should throw error for unsupported handedness', () => {
      const configWithoutNone = {
        ...
        layout: {
          [XRHandedness.Right]:
            mockControllerConfig.layout[XRHandedness.Right]!,
        },
      };
  ...
  describe('updateButtonValue method', () => {
    ...
    it('should update analog button value within valid range', () => {
      ...
      expect(
        (mockGamepad[P_GAMEPAD].buttonsMap as any).trigger[P_GAMEPAD]
          .pendingValue,
      ).toBe(0.5);
    ...
    it('should warn and reject values greater than 1', () => {
      ...
      expect(mockConsoleWarn).toHaveBeenCalledWith(
        'Out-of-range value 1.5 provided for button trigger.',
      );
    });
    ...
    it('should warn and reject negative values', () => {
      ...
      expect(mockConsoleWarn).toHaveBeenCalledWith(
        'Out-of-range value -0.5 provided for button trigger.',
      );
    });
    ...
    it('should update binary button with value 0', () => {
      ...
      expect(
        (mockGamepad[P_GAMEPAD].buttonsMap as any).a[P_GAMEPAD].pendingValue,
      ).toBe(0);
      expect(mockConsoleWarn).not.toHaveBeenCalled();
    });
    ...
    it('should warn and reject non-binary values for binary buttons', () => {
      ...
      expect(mockConsoleWarn).toHaveBeenCalledWith(
        'Non-binary value 0.5 provided for binary button a.',
      );
    });
    ...
    it('should warn for non-existent button', () => {
      ...
      expect(mockConsoleWarn).toHaveBeenCalledWith(
        'Current controller does not have button nonexistent.',
      );
    });
    ...
    it('should handle multiple button updates', () => {
      ...
      expect(
        (mockGamepad[P_GAMEPAD].buttonsMap as any).grip[P_GAMEPAD].pendingValue,
      ).toBe(0.3);
      expect(
        (mockGamepad[P_GAMEPAD].buttonsMap as any).a[P_GAMEPAD].pendingValue,
      ).toBe(1);
  ...
  describe('updateButtonTouch method', () => {
    ...
    it('should set button touch to true', () => {
      ...
      expect(
        (mockGamepad[P_GAMEPAD].buttonsMap as any).trigger[P_GAMEPAD].touched,
      ).toBe(true);
    });
    ...
    it('should handle multiple touch updates', () => {
      ...
      expect(
        (mockGamepad[P_GAMEPAD].buttonsMap as any).grip[P_GAMEPAD].touched,
      ).toBe(false);
      expect(
        (mockGamepad[P_GAMEPAD].buttonsMap as any).a[P_GAMEPAD].touched,
      ).toBe(true);
    });
  ...
  describe('updateAxis method', () => {
    ...
    it('should warn and reject x-axis values greater than 1', () => {
      ...
      expect(mockConsoleWarn).toHaveBeenCalledWith(
        'Out-of-range value 1.5 provided for thumbstick axes.',
      );
    });
    ...
    it('should warn for non-existent axis', () => {
      ...
      expect(mockConsoleWarn).toHaveBeenCalledWith(
        'Current controller does not have nonexistent axes.',
      );
    });
  ...
  describe('updateAxes method', () => {
    ...
    it('should warn and reject when x value is out of range', () => {
      ...
      expect((mockGamepad[P_GAMEPAD].axesMap as any).thumbstick.y).toBe(0); // unchanged
      expect(mockConsoleWarn).toHaveBeenCalledWith(
        'Out-of-range value x:1.5, y:0.5 provided for thumbstick axes.',
      );
    });
    ...
    it('should warn and reject when y value is out of range', () => {
      ...
      expect((mockGamepad[P_GAMEPAD].axesMap as any).thumbstick.y).toBe(0); // unchanged
      expect(mockConsoleWarn).toHaveBeenCalledWith(
        'Out-of-range value x:0.5, y:-1.5 provided for thumbstick axes.',
      );
    });
    ...
    it('should warn and reject when both values are out of range', () => {
      ...
      expect((mockGamepad[P_GAMEPAD].axesMap as any).thumbstick.y).toBe(0); // unchanged
      expect(mockConsoleWarn).toHaveBeenCalledWith(
        'Out-of-range value x:1.5, y:-1.5 provided for thumbstick axes.',
      );
    });
