...
describe('control-math utilities', () => {
  ...
  describe('directionTo', () => {
    test('should calculate forward direction', () => {
      const result = directionTo({ x: 0, y: 0, z: 0 }, { x: 0, y: 0, z: -1 });
      expect(result.x).toBeCloseTo(0);
      expect(result.y).toBeCloseTo(0);
    ...
    test('should calculate right direction', () => {
      const result = directionTo({ x: 0, y: 0, z: 0 }, { x: 1, y: 0, z: 0 });
    ...
    test('should calculate up direction', () => {
      const result = directionTo({ x: 0, y: 0, z: 0 }, { x: 0, y: 1, z: 0 });
      expect(result.x).toBeCloseTo(0);
    ...
    test('should normalize diagonal direction', () => {
      const result = directionTo({ x: 0, y: 0, z: 0 }, { x: 1, y: 1, z: 1 });
    ...
    test('should return default forward for coincident points', () => {
      const result = directionTo({ x: 1, y: 2, z: 3 }, { x: 1, y: 2, z: 3 });
      expect(result.x).toBeCloseTo(0);
      expect(result.y).toBeCloseTo(0);
      expect(result.z).toBeCloseTo(-1);
    });
  ...
  describe('waitForCondition (fix #8)', () => {
    ...
    test('should reject on timeout', async () => {
      await expect(waitForCondition(() => false, 50)).rejects.toThrow(
